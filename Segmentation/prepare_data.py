...
real_data_path = Path('/mnt/disk2_hdd/mengya/2018_RoboticSceneSegmentation/ISINet_Train_Val')
semisyn_train_data_path = Path('/mnt/disk2_hdd/mengya/surgical_blender/simulation_dataset_2DTool_samebg')
fullysyn_train_data_path = Path('/mnt/disk2_hdd/mengya/surgical_blender/simulation_dataset_3DTool')

# # cropped_train_path = data_path / 'cropped_train'
# cropped_train_path = data_path / 'dataset'
...
#         instrument_folder = 'dataset' + str(instrument_index)
...
#         binary_mask_folder = (cropped_train_path / instrument_folder / 'mask_blood')
