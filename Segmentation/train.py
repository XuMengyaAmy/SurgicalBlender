...
def main():
    ...
    arg('--root', default='runs_new/mask_realEndo18/LinkNet34', help='checkpoint root')
    arg('--batch-size', type=int, default=64)
    arg('--n-epochs', type=int, default=60)
    arg('--lr', type=float, default=0.001) #  0.0001   0.001
    ...
    if args.type == 'parts':
        ...
        num_classes = 8   ############### fit to our dataset inclduing background class 7+1
    else:
        num_classes = 1
    ...
    train_file_names, val_file_names = get_split(args.dataset, args.fold, args.add_real,args)
