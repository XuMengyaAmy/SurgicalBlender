...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'IC_A', 'DC_B', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'IC_B', 'cycle_B', 'idt_B','DC_A']
    ...
    def backward_D_A(self):
        ...
        self.loss_DC_A = self.criterionDC.call_pytorch_impl(self.fake_B)
    ...
    def backward_D_B(self):
        ...
        self.loss_DC_B = self.criterionDC.call_pytorch_impl(self.fake_A)
